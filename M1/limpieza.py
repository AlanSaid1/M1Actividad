...
#Agents: Permite manipular a los agentes en tanto a sus movimientos y caracteristicas.
#Scheduler: Es un modelo especial que controla el orden en el que los agentes son activados.
...
class limpiadorAgente(Agent):
    #Funcion que inicializa las variables que contiene cada uno de los agentes.
    #Lleva un registro del estado del agente respecto a las casillas.
    #En el modelo regresa la cantidad de movimientos realizados por cada agente.
    ...
    def step(self):
        ...
        #El agente se mueve.
            ...
            #Al incluir una propiedad de tipo random, el agente elige una de las 8 direcciones para moverse.
...
class limpiadorModelo(Model):
    ...
    #Estas variables al finalizar el programa nos regresan un control de lo obtenido con el modelo.
    def __init__(self, ancho, alto, numAgentes, suciedad, tiempoMax):
        ...
        # Crear y registrar las celdas sucias tomando en cuenta nuestro alto y ancho de tupla aleatoriamente.
        id = 0
    ...
    def step(self):
        #Al ya no existir coordenadas sucias o se haya llegado al tiempo máximo posible, termina el programa.
